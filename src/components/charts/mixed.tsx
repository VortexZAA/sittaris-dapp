...
const ApexChart = ({ seriesNames = true }: { seriesNames?: boolean }) => {
  ...
  return (
    <div className="w-full apexChart flex flex-col text-black dark:text-white py-6 ">
      <div className="w-full flex items-end text-xl gap-3 text-black/80 dark:text-white/80">
        <div className="w-1/3 max-w-xs">
        <ZoneDropDown placement="bottom-end" data={[
          { label: "Zone 1", key: "zone1" },
          { label: "Zone 2", key: "zone2" },
          { label: "Zone 3", key: "zone3" },
          { label: "Zone 4", key: "zone4" },
        ]} />
        </div>
