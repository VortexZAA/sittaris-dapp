        ...
        <Dialog as="div" open={modal} onClose={Close}>
          ...
          >
            <div className="flex min-h-screen items-center justify-center px-4 py-8">
              ...
              >
                <Dialog.Panel className="panel  absolute z-10 flex w-fit max-w-[95vw] min-w-[50vw] min-h-[60vh] bg-white/90 dark:bg-black/90 flex-col  overflow-hidden rounded-lg  p-0 text-black dark:text-gray-700 2xl:max-w-[80vw] shadow-md shadow-white/20">
                  ...
                  <div className="  h-96 w-full flex flex-col overflow-y-auto relative">
                    {children}
                  </div>
                </Dialog.Panel>
              </Transition.Child>
