  ...
  return (
    <div className="flex flex-col w-full gap-2">
      ...
      <div className="flex w-full items-center relative text-white h-11">
        <input
          className=" bg-black/20 backdrop-blur-md rounded-md h-full w-full flex items-center px-4 py-2 focus:outline-none border-2 border-white/5 focus:border-blue-500"
          type={typeInput}
          {...props}
        />
        {type === "password" && (
